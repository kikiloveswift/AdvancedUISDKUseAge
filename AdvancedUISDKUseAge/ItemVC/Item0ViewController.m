...
- (void)initData
{
    _dataArr = @[@"DynamicViewController",@"KeyFrameViewController",@"BerKeyFrameViewController",@"ExchangeViewController",@"TransitionViewController",@"SnowAnimationViewController"];
}
- (void)initUI
{
